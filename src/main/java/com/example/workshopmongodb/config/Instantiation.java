...
public class Instantiation implements CommandLineRunner {
   ...
   private PostRepository postRepository;
    ...
    public void run(String... args) throws Exception {
        ...
        Post postOne = new Post(null, simpleDateFormat.parse("21/03/2018"), "Bora viajar", "Partiu Rio de janeiro", userOne);
        Post postTwo = new Post(null, simpleDateFormat.parse("19/08/2021"), "Pedra azul", "Pedra azul esta frio", userTree);
